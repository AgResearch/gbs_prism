...
WORKDIR=/dataset/2023_illumina_sequencing_a/scratch/postprocessing/gbs_redo
...
for cohort_path in /dataset/2023_illumina_sequencing_a/scratch/postprocessing/gbs/23*/SQ*; do
   ...
   # patch the orignal callback - e.g. /dataset/2023_illumina_sequencing_a/scratch/postprocessing/gbs/230414_A01439_0164_AHW5YGDRX2/SQ2081.all.deer.PstI/SQ2081.all.deer.PstI.KGD_tassel3.genotype_prism.sh
   ...
   cat $original_callback | sed 's/\/hiseq\//\/2023_illumina_sequencing_a\//g' | sed 's/postprocessing\/gbs/postprocessing\/gbs_redo/g' > $redo_callback
