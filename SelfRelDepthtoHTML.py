...
# - the output should be sent to /bifo/scratch/2023_illumina_sequencing_b/postprocessing/ so that the paths
# work when opened 
#
import sys
import os
...
def generate_run_plot():
    ...
    for record in record_array:
        # these are like
        # /bifo/scratch/2023_illumina_sequencing_b/postprocessing/180130_D00390_0343_BCBG7MANXX.gbs/SQ0618.processed_sample/uneak/PstI.PstI.cohort/KGD -0.06391309 2.17314e-15
        ...
        #print record
        #['/bifo/scratch/2023_illumina_sequencing_b/postprocessing/180627_D00390_0375_BCCHBJANXX.gbs/SQ2741.processed_sample/uneak/all.ApeKI.ApeKI.cohort/KGD',
        ...
        # /bifo/scratch/2023_illumina_sequencing_b/postprocessing/180130_D00390_0343_BCBG7MANXX.gbs/SQ0618.processed_sample/uneak/PstI.PstI.cohort/KGD
        # to this
        ...
        if re.search("gseq_processing", path) is not None:
            ...
            relpath=os.path.relpath(path, "/dataset/2023_illumina_sequencing_b/scratch/postprocessing")
        ...
        if run_match is None:
            run_match=re.search("/dataset/2023_illumina_sequencing_b/scratch/postprocessing/([^\/]+)\.gbs/",path)
            if run_match is None:
        ...
        if os.path.exists(os.path.join("/dataset/2023_illumina_sequencing_b/scratch/postprocessing/", "%s_plots.html"%run)):
            plots_page="\\\\isamba\\dataset\\2023_illumina_sequencing_b\\scratch\\postprocessing\\%s_plots.html"%run
            path="<a href=\"%s\" target=plots_page>%s</a>"%(plots_page, os.path.join("/dataset/2023_illumina_sequencing_b/scratch/postprocessing/", "%s_plots.html"%run))
        else:
