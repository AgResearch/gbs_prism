...
if [ -z "$1" ]; then
   echo "examples : 
debug_barcodes.sh /bifo/scratch/2023_illumina_sequencing_b/postprocessing/gbs/230623_A01439_0188_AHFFGNDRX3/SQ2128.all.microbes.PstI/./Illumina/SQ2128_HFFGNDRX3_s_1_fastq.txt.gz
"
   exit 1
elif [ ! -f $1 ]; then
